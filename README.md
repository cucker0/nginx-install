...
举例：
nginx-1.12.1
yum -y install git; mkdir /usr/local/src/nginx-1.12.1_v0; cd /usr/local/src/nginx-1.12.1_v0; git clone https://github.com/cucker0/nginx-install.git; cd nginx-install/nginx-1.12.1; bash ./nginx_install.sh; . /etc/profile;

nginx-1.12.2
yum -y install git; mkdir /usr/local/src/nginx-1.12.2_v0; cd /usr/local/src/nginx-1.12.2_v0; git clone https://github.com/cucker0/nginx-install.git; cd nginx-install/nginx-1.12.2; bash ./nginx_install.sh; . /etc/profile;
